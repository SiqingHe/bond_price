...
def param_xgbPredict(model,X_test,y_test):
...
def residule_record(y_pred,test_pd,y_column,save_path):
...
def main():
    ...
    valid_pred = param_xgbPredict(model,X_valid,y_valid)
    test_pred = param_xgbPredict(model,X_test,y_test)
    ...
    residule_record(train_pred,train_pd,y_column,save_train)
    residule_record(valid_pred,valid_pd,y_column,save_valid)
    residule_record(test_pred,test_pd,y_column,save_test)
